...
use FlexPHP\Bundle\LocationBundle\Domain\PaymentMethod\Response\UpdatePaymentMethodResponse;
...
final class UpdatePaymentMethodUseCase
{
    ...
    public function execute(UpdatePaymentMethodRequest $request): UpdatePaymentMethodResponse
    {
        return new UpdatePaymentMethodResponse($this->paymentMethodRepository->change($request));
    }
}
