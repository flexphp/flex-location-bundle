...
final class City
{
    ...
    public function stateIdInstance(): State
    {
        return $this->stateIdInstance ?: new State;
    }
    ...
    public function setStateIdInstance(State $state): void
    {
        $this->stateIdInstance = $state;
    }
